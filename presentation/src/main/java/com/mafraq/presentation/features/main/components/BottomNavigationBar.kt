...
import com.mafraq.presentation.navigation.destinations.navigateToGroupChat
...
fun BottomNavigationBar(navController: NavController) {
    ...
    NavigationBar {
        ...
        val isGroupChatSelected = remember(currentRoute) { Screen.GroupChat.route == currentRoute }
        NavigationBarItem(
            ...
            onClick = navController::navigateToGroupChat
        )
